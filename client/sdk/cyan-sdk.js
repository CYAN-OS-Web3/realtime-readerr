;(function(){
  class CyanSDK {
    ...
    async speak(params){
      const p = params || {}
      const body = { text: p.text || '', user_id: p.userId || '', language: p.language || 'en-US', gender: p.gender || 'female' }
      const r = await fetch(`${this.baseUrl}/api/tts/speak`, { method: 'POST', headers: Object.assign(this._headers(), { 'Content-Type': 'application/json' }), body: JSON.stringify(body) })
