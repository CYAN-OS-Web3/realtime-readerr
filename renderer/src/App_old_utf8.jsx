...
const ControlHub = () => {
  ...
  const handleLogout = () => {
    ...
    // Sinh lß║íi ID ngß║½u nhi├¬n ─æß╗â d├╣ng tiß║┐p chß║┐ ─æß╗Ö Guest
  ...
  const languages = [
    { code: 'vi-VN', name: 'Vietnamese', flag: '≡ƒç╗≡ƒç│' },
    { code: 'en-US', name: 'English', flag: '≡ƒç║≡ƒç╕' },
    { code: 'es-ES', name: 'Spanish', flag: '≡ƒç¬≡ƒç╕' },
    { code: 'fr-FR', name: 'French', flag: '≡ƒç½≡ƒç╖' },
    { code: 'de-DE', name: 'German', flag: '≡ƒç⌐≡ƒç¬' },
    { code: 'it-IT', name: 'Italian', flag: '≡ƒç«≡ƒç╣' },
    { code: 'pt-PT', name: 'Portuguese', flag: '≡ƒç╡≡ƒç╣' },
    { code: 'ru-RU', name: 'Russian', flag: '≡ƒç╖≡ƒç║' },
    { code: 'ja-JP', name: 'Japanese', flag: '≡ƒç»≡ƒç╡' },
    { code: 'ko-KR', name: 'Korean', flag: '≡ƒç░≡ƒç╖' },
    { code: 'zh-CN', name: 'Mandarin', flag: '≡ƒç¿≡ƒç│' },
    { code: 'hi-IN', name: 'Hindi', flag: '≡ƒç«≡ƒç│' },
    { code: 'ar-SA', name: 'Arabic', flag: '≡ƒç╕≡ƒçª' },
    { code: 'bn-BD', name: 'Bengali', flag: '≡ƒçº≡ƒç⌐' },
    { code: 'ms-MY', name: 'Malay', flag: '≡ƒç▓≡ƒç╛' },
    { code: 'id-ID', name: 'Indonesian', flag: '≡ƒç«≡ƒç⌐' },
    { code: 'th-TH', name: 'Thai', flag: '≡ƒç╣≡ƒç¡' },
    { code: 'tr-TR', name: 'Turkish', flag: '≡ƒç╣≡ƒç╖' },
    { code: 'pl-PL', name: 'Polish', flag: '≡ƒç╡≡ƒç▒' },
    { code: 'uk-UA', name: 'Ukrainian', flag: '≡ƒç║≡ƒçª' },
    { code: 'nl-NL', name: 'Dutch', flag: '≡ƒç│≡ƒç▒' },
    { code: 'sv-SE', name: 'Swedish', flag: '≡ƒç╕≡ƒç¬' },
    { code: 'fi-FI', name: 'Finnish', flag: '≡ƒç½≡ƒç«' },
    { code: 'da-DK', name: 'Danish', flag: '≡ƒç⌐≡ƒç░' },
    { code: 'no-NO', name: 'Norwegian', flag: '≡ƒç│≡ƒç┤' },
    { code: 'cs-CZ', name: 'Czech', flag: '≡ƒç¿≡ƒç┐' },
    { code: 'el-GR', name: 'Greek', flag: '≡ƒç¼≡ƒç╖' },
    { code: 'he-IL', name: 'Hebrew', flag: '≡ƒç«≡ƒç▒' },
    { code: 'ro-RO', name: 'Romanian', flag: '≡ƒç╖≡ƒç┤' },
    { code: 'hu-HU', name: 'Hungarian', flag: '≡ƒç¡≡ƒç║' },
    { code: 'sk-SK', name: 'Slovak', flag: '≡ƒç╕≡ƒç░' },
    { code: 'bg-BG', name: 'Bulgarian', flag: '≡ƒçº≡ƒç¼' },
    { code: 'ca-ES', name: 'Catalan', flag: '≡ƒçª≡ƒç⌐' },
    { code: 'hr-HR', name: 'Croatian', flag: '≡ƒç¡≡ƒç╖' },
    { code: 'sr-RS', name: 'Serbian', flag: '≡ƒç╖≡ƒç╕' },
    { code: 'sl-SI', name: 'Slovenian', flag: '≡ƒç╕≡ƒç«' },
    { code: 'et-EE', name: 'Estonian', flag: '≡ƒç¬≡ƒç¬' },
    { code: 'lv-LV', name: 'Latvian', flag: '≡ƒç▒≡ƒç╗' },
    { code: 'lt-LT', name: 'Lithuanian', flag: '≡ƒç▒≡ƒç╣' },
    { code: 'fil-PH', name: 'Filipino', flag: '≡ƒç╡≡ƒç¡' }
  ];
  ...
  useEffect(() => {
    ...
    navigator.mediaDevices.enumerateDevices().then(devs => {
        ...
        if (saved) {
            ...
            const prefer = outs.find(o => /Bluetooth|Headset|ΦÇ│µ£║|Tai nghe|Audio|Speaker/i.test(o.label));
  ...
  const createVoiceChangeOrder = async () => {
    try {
      setVoiceUiStatus('Creating $5 paymentΓÇª');
      ...
      setVoiceUiStatus('Created. Opening PayPalΓÇª');
  ...
  const completeVoiceChange = async () => {
    try {
      setVoiceUiStatus('Updating voiceΓÇª');
      const base = backendUrl || (await window.electronAPI?.getBackendUrl?.()) || '';
      const uid = installId || (await window.electronAPI?.getInstallId?.()) || '';
      if (!base || !uid) { setVoiceUiStatus('Missing backend URL or user ID'); return; }
  ...
  const startMicrophone = async () => {
    try {
        ...
        if (noiseReduction) {
            ...
            console.log('Audio chain with noise gate: source ΓåÆ compressor ΓåÆ gainNode ΓåÆ noiseGate ΓåÆ worklet');
        } else {
            gainNode.connect(workletNode);
            console.log('Simple audio chain: source ΓåÆ compressor ΓåÆ gainNode ΓåÆ worklet');
        }
        ...
        workletNode.port.onmessage = (e) => {
            ...
            if (noiseGateMode === 'adaptive') {
                ...
                const noiseMultiplier = 1.02; // Voice chß╗ë cß║ºn 2% tr├¬n nß╗ün
                const baseThreshold = currentAmbient * noiseMultiplier;
                const userThreshold = sensitivityRef.current / 4; // nhß║íy h╞ín nß╗»a
                effectiveThreshold = Math.max(baseThreshold, userThreshold);
                adaptiveThresholdRef.current = effectiveThreshold;
            } else {
                effectiveThreshold = sensitivityRef.current / 4; // nhß║íy h╞ín
            }
            
            // Noise gate control
            if (noiseGateRef.current) {
                // Cho ph├⌐p pass-through mß║ính h╞ín khi d╞░ß╗¢i ng╞░ß╗íng ─æß╗â tr├ính kß║╣t gate
            ...
            // ALWAYS send audio when noise reduction is OFF, hoß║╖c khi v╞░ß╗út 30% ng╞░ß╗íng ─æß╗â tr├ính kß║╣t
            if (!noiseReduction || vol > effectiveThreshold * 0.3) {
                ...
                if (silenceMs > 1200) {
                    if (now - lastFinalizeTsRef.t > 2500) { // T─âng debounce l├¬n 2.5s
    ...
    <div className="flex gap-4 p-4 bg-gray-900 min-h-screen font-sans text-gray-200">
      ...
      <div className="w-[400px] bg-black rounded-lg shadow-2xl border border-cyan-500/30 flex flex-col overflow-hidden">
        ...
        <div className="px-4 py-4 space-y-3 flex-1 overflow-y-auto">
           ...
           {ttsEngine === 'elevenlabs' && (
             <div className="bg-gray-900 border border-gray-800 rounded-lg p-2.5 space-y-2.5">
               ...
               >
                 ...
                 <span className="text-[10px] text-gray-500 font-mono">{installId || 'ΓÇö'}</span>
               </button>
          ...
          >
            {isTranslating ? 'ΓÅ╣ STOP STREAMING' : 'Γû╢ START LIVE TRANSLATION'}
          </button>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {previewText.length === 0 ? (
                      <div className="text-xs py-1 px-1.5 rounded border border-gray-800 text-gray-600">ΓÇö</div>
                  ) : (
      ...
      {showOverlay && (
        <div className="fixed top-10 right-10 w-[400px] bg-black/90 backdrop-blur-sm rounded-lg border border-cyan-500/30 p-4 shadow-2xl z-50">
          ...
          <div className="mt-3 pt-3 border-t border-gray-800 flex items-center justify-between">
            <span className="text-xs text-gray-500">
                {languages.find(l => l.code === sourceLang)?.flag} ΓåÆ {languages.find(l => l.code === targetLang)?.flag}
            </span>
